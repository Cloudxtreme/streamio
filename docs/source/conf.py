# -*- coding: utf-8 -*-
#
# streamio documentation build configuration file, created by
...
exec(
    compile(
        open(
            path.abspath(path.join(path.dirname(__file__), "../../streamio/version.py")),
            "r"
        ).read(),
...
bitbucket_project_url = 'https://bitbucket.org/prologic/streamio'
...
latex_documents = [
    (
        'index', 'streamio.tex', u'streamio Documentation',
